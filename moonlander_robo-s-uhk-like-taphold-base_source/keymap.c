...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    TD(DANCE_0),    KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           KC_DELETE,                                                                      KC_EQUAL,       KC_H,           KC_J,           KC_K,           KC_L,           KC_SCOLON,      KC_QUOTE,       
    ...
    TD(DANCE_1),    LM(3,MOD_LGUI), LT(4,KC_NO),                    LT(4,KC_NO),    KC_ENTER,       KC_SPACE
  ),
  [1] = LAYOUT_moonlander(
    ...
    TD(DANCE_2),    KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_MINUS
  ),
  [2] = LAYOUT_moonlander(
  ...
  [5] = LAYOUT_moonlander(
    ...
    TO(0),          KC_TRANSPARENT, KC_MS_BTN2,     KC_MS_BTN3,     KC_MS_BTN1,     KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_PGDOWN,      KC_MS_WH_DOWN,  KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRANSPARENT, KC_TRANSPARENT, 
